local snumericvars SexAtBirth BaselineHouseholdIncome
local sorderedvars Discipline
local sunorderedvars ProviderType
local vnumericvars SNAPEligible AssessmentScore
local vunorderedvars ProviderDelivery
local vorderedvars MotherEducation
local vunorderedvars ProviderDelivery
local weightvar BaseWeight
local waveresponseflag WaveResponse
local wave WaveID
local j ProviderID
local i ChildID
